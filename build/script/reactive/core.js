...
(function (Reactive) {
    ...
    var Stream = (function () {
        ...
        Stream.prototype.trigger_event = function (event) {
            if (!this.closed) {
                this.observers.map(function (observer) {
                    return observer.on_event(event);
                });
            } else {
                throw 'closed';
            }
        ...
        Stream.prototype.trigger_error = function (error) {
            if (!this.closed) {
                this.observers.map(function (observer) {
                    return observer.on_error(error);
                });
            } else {
                throw 'closed';
            }
        ...
        Stream.prototype.trigger_close = function (reason) {
            ...
            return this.observers.map(function (observer) {
                return observer.on_close(reason);
            });
        };
        ...
        Stream.prototype.map = function (func) {
            ...
            this.listen(function (event) {
                return controller.add(func(event));
            }, function (error) {
        ...
        */
        Stream.prototype.log = function (name) {
            ...
            this.listen(function (event) {
                return console.log(repr + ":event: ", event);
            }, function (error) {
                return console.log(repr + ":error: ", error);
            }, function (reason) {
                return console.log(repr + ":close: ", reason);
            });
        };
        return Stream;
    })();
        ...
        */
        ...
        Signal.derived = function (signals, comp) {
            var recompute = function () {
                return Function.apply(comp, signals.map(function (s) {
                    return s.value;
                }));
            };
    ...
    var Future = (function () {
        ...
        Future.prototype.then = function (handler, err_handler) {
            ...
            this.observers.push(new FutureObserver(function (value) {
                return comp.complete(handler(value));
            }, on_error));
            return comp.future;
        };
